return {
	...
	-- Monochrome theme
	mono_white = 0xffffffff,
	mono_light_gray = 0xffcccccc,
	mono_gray = 0xff999999,
	mono_dark_gray = 0xff666666,
	mono_darker_gray = 0xff444444,
	mono_black = 0xff222222,
	mono_bg = 0xff1a1a1a,
	mono_border = 0xff555555,
}
