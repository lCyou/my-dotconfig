...
local wifi_up_graph = sbar.add("graph", "widgets.wifi1_graph", 42, {
	...
	graph = {
		...
		fill_color = colors.mono_light_gray,
		fill = true,
		height = 17,
		line_width = 1,
		padding_left = 0,
...
local wifi_bracket = sbar.add("bracket", "widgets.wifi.bracket", {
	...
	background = { color = colors.mono_bg, border_color = colors.mono_border, border_width = 2 },
	popup = {
		align = "center",
		height = 30,
		background = { color = colors.mono_bg, border_color = colors.mono_border, border_width = 2 },
...
wifi_up:subscribe("network_update", function(env)
	...
	-- Set the color
	local up_color = (upload_value == 0) and colors.mono_darker_gray or colors.mono_light_gray
	local down_color = (download_value == 0) and colors.mono_darker_gray or colors.mono_gray
	...
	sbar.exec("ipconfig getifaddr en0", function(ip)
		...
		wifi:set({
			icon = {
				...
				color = connected and colors.mono_white or colors.mono_darker_gray,
			},
		})
	end)
end)
